...
\end{equation}
The maintained baseline is complete coverage, as in the original analysis. Production has zero marginal cost, while quality entails the fixed cost
