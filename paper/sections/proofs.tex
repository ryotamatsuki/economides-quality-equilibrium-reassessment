...
\[
 p_1\leq p_2+\delta-1.
\]
Evaluated against the interior candidate $p_2=1-\delta/3$, the highest full-market capture price is $2\delta/3$. The difference between firm 1's interior-candidate revenue and this capture revenue is
\[
 \frac12\left(1+\frac{\delta}{3}\right)^2-\frac{2\delta}{3}
 =\frac{(\delta-3)^2}{18}\geq0.
\]
The symmetric calculation for firm 2 gives $(\delta+3)^2/18$. Hence the interior candidate is globally stable when $-3\leq\delta\leq3$, including the limiting boundary cases.
